      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
          {dashboardData.stats.map((stat, index) => {
            ...
            return (
              <div key={index} className="bg-white rounded-xl p-6 border hover:border-blue-500/50 transition-all hover:scale-105 transform duration-200">
          ...
          {activeTab === 'memberships' && (
            <div className="space-y-4">
              {filteredMemberships.map((membership) => (
                <div key={membership.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{membership.userType} Membership</p>
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-sm text-gray-600 mt-1">₱{membership.monthlyPrice.toLocaleString()}/month</p>
                    <p className="text-xs text-gray-500">Ref: {membership.membershipId}</p>
                  </div>
                </div>
              ))}
            </div>
                ...
                <div key={booking.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{booking.activityType}</p>
                      <p className="text-xs text-blue-600">{booking.duration} hours</p>
                      <p className="text-xs text-gray-500">{booking.participants} participants</p>
                    </div>
                  </div>
                  <div className="text-right">
                    ...
                    <p className="text-sm text-gray-600 mt-1">{formatDisplayDate(booking.date)}</p>
                ...
                <div key={session.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-blue-600">{session.duration} hours</p>
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-sm text-gray-600 mt-1">{formatDisplayDate(session.date)}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl p-6 border text-center">
            ...
            <p className="text-4xl font-bold text-blue-600">{dashboardData.totalMembers}</p>
            <p className="text-sm text-gray-600 mt-2">Registered members in the system</p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 border text-center">
            ...
            <p className="text-sm text-gray-600 mt-2">Studio & Coach bookings</p>
          </div>
