...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="bg-card border-border">
              <CardContent className="p-8">
                ...
                <p className="text-3xl font-bold text-orange-500 mb-4">
                  ₱1,500<span className="text-lg text-muted-foreground">/month</span>
                </p>
            ...
            <Card className="bg-card border-orange-500 relative">
              ...
              <CardContent className="p-8">
                ...
                <p className="text-3xl font-bold text-orange-500 mb-4">
                  ₱2,500<span className="text-lg text-muted-foreground">/month</span>
                </p>
                <ul className="space-y-2 text-muted-foreground">
            ...
            <Card className="bg-card border-border">
              <CardContent className="p-8">
                ...
                <p className="text-3xl font-bold text-orange-500 mb-4">
                  ₱3,500<span className="text-lg text-muted-foreground">/month</span>
                </p>
                <ul className="space-y-2 text-muted-foreground">
      ...
      {/* ────── Coaches ────── */}
      <section id="coaches" className="py-20 bg-muted">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">Meet Our Expert Coaches</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Train with certified professionals dedicated to your success at APF
              Tanauan
            </p>
          </div>
            ...
            {[
              {
                ...
                experience: "8 years",
                certs: "NASM-CPT, CSCS",
                bio: "Specializes in strength building and powerlifting techniques. Helped 200+ clients achieve their strength goals.",
              },
              {
                name: "Sarah Wilson",
                specialty: "Boxing & Cardio Fitness",
                rating: 4.8,
                sessions: 350,
                experience: "6 years",
                certs: "Boxing Coach Level 2, ACSM",
                bio: "Former amateur boxer with expertise in cardio conditioning and boxing fundamentals for all fitness levels.",
              },
              {
                name: "David Chen",
                ...
                sessions: 400,
                experience: "10 years",
                certs: "Karate Black Belt, Yoga RYT-200",
                bio: "Master martial artist focusing on discipline, flexibility, and mind-body connection through traditional techniques.",
              },
            ].map((c, i) => (
              <Card
                key={i}
                className="bg-card border-orange-500/20 hover:border-orange-500/40 transition-all duration-300 hover:scale-105"
              >
                <CardContent className="p-6">
                  <div className="text-center mb-4">
                    ...
                    <p className="text-orange-500 mb-2 font-semibold">
                      {c.specialty}
                    </p>
                  ...
                  <div className="space-y-2 text-sm text-muted-foreground">
                    ...
                    <p className="italic">{c.bio}</p>
                  </div>

                  <Button className="w-full mt-4 bg-orange-500 hover:bg-orange-600 text-black font-semibold">
